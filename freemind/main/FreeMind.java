...
public class FreeMind extends JFrame implements FreeMindMain {
	...
	protected static final String PORT_FILE = "portFile";

	protected static final String FREE_MIND_PROGRESS_LOAD_MAPS = "FreeMind.progress.loadMaps";

	protected static final String FREE_MIND_PROGRESS_LOAD_MAPS_NAME = "FreeMind.progress.loadNamedMaps";

	protected static final String SPLIT_PANE_POSITION = "split_pane_position";

	protected static final String SPLIT_PANE_LAST_POSITION = "split_pane_last_position";
	...
	protected static Properties defProps;

	protected MenuBar menuBar;

	protected JLabel status;

	protected Map filetypes; // Hopefully obsolete. Used to store applications

	// used to open different file types

	protected File autoPropertiesFile;

	protected File patternsFile;

	Controller controller;// the one and only controller

	protected FreeMindCommon mFreeMindCommon;

	protected static FileHandler mFileHandler;
	protected static boolean mFileHandlerError = false;

	protected JScrollPane mScrollPane = null;

	protected JSplitPane mSplitPane;

	protected JComponent mContentComponent = null;

	protected JTabbedPane mTabbedPane = null;

	protected ImageIcon mWindowIcon;

	protected boolean mStartupDone = false;

	protected List mStartupDoneListeners = new Vector();

	protected EditServer mEditServer = null;

	protected Vector mLoggerList = new Vector();

	protected static LogFileLogHandler sLogFileHandler;
...
//		eventQueue.push(new MyEventQueue());
	 ...
	 * @throws IOException
	 */
	protected void execWindows(String pCommand) throws IOException {
	...
	protected String transpose(String input, char findChar, String replaceString) {
	...
	protected String getProgramForFile(String type) {
		if (filetypes == null) {
	...
	protected void setupSpellChecking() {
...
//				}
	...
	protected void checkForAnotherInstance(String[] pArgs) {
		String portFile = getPortFile();
		if (portFile == null) {
			return;
		}
	...
	protected void setScreenBounds() {
		// Create the MenuBar
	...
	protected ModeController createModeController(final String[] args) {
	...
	protected int getMaximumNumberOfMapsToLoad(String[] args) {
	...
	protected void loadMaps(final String[] args, ModeController pModeController,
			FeedBack pFeedBack) {
	...
	protected LastStateStorageManagement getLastStateStorageManagement() {
	 ...
	 */
	protected boolean processLoadEventFromStartupPhase() {
	...
	protected boolean processLoadEventFromStartupPhase(String propertyKey) {
	...
	protected void removeContentComponent() {
		if (mTabbedPane != null) {
	...
	protected void setContentComponent() {
		if (mTabbedPane != null) {
			if (mTabbedPane.getSelectedIndex() >= 0) {
				mTabbedPane.setComponentAt(mTabbedPane.getSelectedIndex(),
						mContentComponent);
